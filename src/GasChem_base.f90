...
!$INSERT night_GasPhotoRateCoeffs

  else
    ! daytime, calculate the Js
    call CalcJPhoto(cz, zalt_m)

!$INSERT GasPhotoRateCoeffs
...
!$INSERT CODE_GasThermalRateCoeffs
